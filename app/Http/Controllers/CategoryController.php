...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $new_category->slug = Str::slug($name, '-'); //slug berguna untuk menyamakan penulisan di URL, ex: Sepatu Olahraga Laki menjadi sepatu-olahraga-cowok
        $new_category->save();
    ...
    {
        $delete_category = \App\Category::onlyTrashed()->paginate(3);
